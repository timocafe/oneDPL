...
template <class _ExecutionPolicy, class _Index, class _Fp, typename... _Args>
void
__parallel_for(oneapi::dpl::__internal::__parallel_tag<_ExecutionPolicy, _Args...>, _ExecutionPolicy&&, _Index __first, _Index __last, _Fp __f)
{
...
void
__parallel_for_each(oneapi::dpl::__internal::__parallel_forward_tag<_ExecutionPolicy, _ForwardIterator>, _ExecutionPolicy&&, _ForwardIterator __begin, _ForwardIterator __end, _Fp __f)
{
