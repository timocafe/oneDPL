...
typename ::std::enable_if<__is_random_access_iterator<_IteratorTypes...>::value, __offload_tag<__device_backend>>::type
...
typename ::std::enable_if<__is_random_access_iterator<_IteratorTypes...>::value, __offload_tag<__fpga_backend>>::type
