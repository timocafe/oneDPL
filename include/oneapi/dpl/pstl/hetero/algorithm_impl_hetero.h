...
void
__pattern_walk1(__offload_tag<_BackendTag> __tag, _ExecutionPolicy&& __exec, _ForwardIterator __first, _ForwardIterator __last,
                _Function __f)
{
    ...
    using __backend_tag_type = typename decltype(__tag)::__backend_tag;

    oneapi::dpl::__par_backend_hetero::__parallel_for(__backend_tag_type{}, __exec, unseq_backend::walk_n<_ExecutionPolicy, _Function>{__f},
                                                      __n, __buf.all_view())
        .wait();
}
...
template <typename _DeviceBackend, typename _ExecutionPolicy, typename _Iterator, typename _Pred>
_Iterator
__pattern_find_if(__offload_tag<_DeviceBackend> __tag, _ExecutionPolicy&& __exec, _Iterator __first, _Iterator __last, _Pred __pred)
{
    if (__first == __last)
        return __last;
    ...
    return __par_backend_hetero::__parallel_find(__backend_tag_type{},
        ::std::forward<_ExecutionPolicy>(__exec),
        __par_backend_hetero::make_iter_mode<__par_backend_hetero::access_mode::read>(__first),
        __par_backend_hetero::make_iter_mode<__par_backend_hetero::access_mode::read>(__last), _Predicate{__pred},
        ::std::true_type{});
