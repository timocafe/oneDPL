...
void
__pattern_walk1(__parallel_forward_tag<_ExecutionPolicy, _ForwardIterator> __tag, _ExecutionPolicy&& __exec,
                _ForwardIterator __first, _ForwardIterator __last, _Function __f)
{
    ...
    __internal::__except_handler([&]() {
        __par_backend::__parallel_for_each(__tag, ::std::forward<_ExecutionPolicy>(__exec), __first, __last, __func);
    });
}
                  ...
                  _ForwardIterator __first, _ForwardIterator __last, _Predicate __pred)
{
    using __tag_type = decltype(__tag);
    return __except_handler([&]() {
        return __parallel_find(__tag, ::std::forward<_ExecutionPolicy>(__exec), __first, __last,
